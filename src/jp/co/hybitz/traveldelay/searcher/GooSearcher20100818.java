...
import jp.co.hybitz.traveldelay.parser.GooDetailParser20100821;
 ...
 */
public class GooSearcher20100818 implements TravelDelaySearcher, GooConst {
	...
	private TravelDelayParser createParser(TravelDelayQuery query) throws XmlPullParserException {
		...
		if (query.getCategory() == null) {
            ...
            ret = new GooDetailParser20100821(xmlParser);
		}
